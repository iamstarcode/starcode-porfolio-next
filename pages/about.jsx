    ...
    return (<>
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-2">
                ...
                <p className="mt-3 text-lg text-slate-600 dark:text-slate-400 font-bold leading-7">
                ...
                <p className="mt-3 text-lg text-slate-600 dark:text-slate-400 font-bold leading-7">Here are some of the techs I currently love playing with.</p>
                ...
                <p className="mt-3 text-lg text-slate-600 dark:text-slate-400 font-bold leading-8">Intrested in learning new things, currently learning Cloud engineering and Web3</p>
            </div>
        </div>
    </>);
}
